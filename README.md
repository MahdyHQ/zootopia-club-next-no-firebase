...
- Legacy App Hosting config assets are historical/reference-only and are not part of the active deployment authority
...
- Legacy/inactive deployment config guidance: see `docs/app-hosting-env-secrets-beginner-guide.md` (historical only)

## Docs

- Main project guide: [Guide-Files/Zootopia_Club_Next_16_2_2_Simplified_Monorepo_Guide_2026_WORKSPACE_UPDATED.md](Guide-Files/Zootopia_Club_Next_16_2_2_Simplified_Monorepo_Guide_2026_WORKSPACE_UPDATED.md)
- Architecture notes: [docs/architecture.md](docs/architecture.md)
- Legacy App Hosting env/secrets guide (historical reference only): [docs/app-hosting-env-secrets-beginner-guide.md](docs/app-hosting-env-secrets-beginner-guide.md)
- Ledger: [zootopia-club-next-ledger.txt](zootopia-club-next-ledger.txt)
