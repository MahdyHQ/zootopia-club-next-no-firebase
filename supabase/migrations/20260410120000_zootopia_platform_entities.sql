-- Zootopia platform persistence (Postgres replacement for Firestore collections).
...
comment on table public.zc_entities is
  'Generic JSON document store mirroring former Firestore collections; owner_uid duplicates body.ownerUid for indexed queries.';
