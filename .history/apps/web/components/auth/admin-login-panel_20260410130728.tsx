...
export function AdminLoginPanel({
  ...
  async function bootstrapAdminSession(idToken: string, gatePassword: string) {
    ...
    const response = await fetch("/api/auth/admin/bootstrap", {
      ...
      body: JSON.stringify({
        idToken,
        adminLoginPassword: gatePassword,
      }),
    });
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const redirectTo = await bootstrapAdminSession(data.session.access_token, adminLoginPassword);
