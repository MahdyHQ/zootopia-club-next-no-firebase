  ...
  switch (code) {
    ...
    case "ADMIN_LOGIN_PASSWORD_REQUIRED":
      return status(
        "warning",
        "warning",
        messages.adminLoginStatusGatePasswordRequiredTitle,
        messages.adminLoginStatusGatePasswordRequiredBody,
      );
    case "ADMIN_LOGIN_PASSWORD_INVALID":
      return status(
        "danger",
        "danger",
        messages.adminLoginStatusGatePasswordInvalidTitle,
        messages.adminLoginStatusGatePasswordInvalidBody,
        "assertive",
      );
    case "auth/app-not-authorized":
    case "auth/invalid-api-key":
