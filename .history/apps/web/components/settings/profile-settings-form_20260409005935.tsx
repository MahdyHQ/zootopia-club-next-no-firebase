...
export function ProfileSettingsForm({
  ...
  function updatePhoneDraft(nextCountryIso2: string, nextPhoneValue: string) {
    ...
    /* react-phone-number-input can emit normalization callbacks that resolve
       ...
       render/update feedback loop in the Settings phone row. Compare against
       the actual state value (phoneValue) rather than a derived memoized value
       to ensure both sides of the comparison use consistent normalization. */
