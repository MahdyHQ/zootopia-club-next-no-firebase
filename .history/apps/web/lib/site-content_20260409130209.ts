    ...
    privacy: {
      ...
      sections: [
        ...
        },
        {
          ...
          body:
            "Your profile can include full name, university code, phone number, phone verification status, and nationality. This information is used for account identity, profile completion requirements, and platform eligibility checks.",
        },
        {
    ...
    privacy: {
      ...
      sections: [
        ...
        },
        {
          ...
          body:
            "قد يتضمن ملفك الشخصي الاسم الكامل، والكود الجامعي، ورقم الهاتف، وحالة التحقق من الهاتف، والجنسية. تُستخدم هذه البيانات لهوية الحساب ومتطلبات اكتمال الملف وقيود الأهلية داخل المنصة.",
        },
        {
