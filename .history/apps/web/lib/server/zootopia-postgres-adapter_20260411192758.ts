 ...
 * Data persistence: Supabase Postgres only — no Firebase/Firestore runtime dependency.
 */
...
/**
 * Legacy alias for backward compatibility with historical import paths.
 * This alias is compatibility-only and is not part of the active runtime naming contract.
 * @deprecated Use `getZootopiaDatabase()` instead.
 */
export const getZootopiaFirestore = getZootopiaDatabase;

/**
 * Legacy class alias for backward compatibility with historical import paths.
 * This alias is compatibility-only and is not part of the active runtime naming contract.
 * @deprecated Use `PgDatabase` instead.
 */
export const PgFirestore = PgDatabase;
