...
/**
 * Legacy alias for backward compatibility with existing repository call sites.
 * @deprecated Use `getZootopiaDatabase()` instead.
 */
export const getZootopiaFirestore = getZootopiaDatabase;

/**
 * Legacy class alias for backward compatibility with existing repository call sites.
