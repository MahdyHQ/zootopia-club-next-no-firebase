...
function resolveProfileState(input: {
  ...
  return {
    ...
    originCountry: completion.normalizedOriginCountry ?? input.originCountry ?? null,
...
function buildUserDocumentFromAuthRecord(
  ...
  const profileState = resolveProfileState({
    ...
    originCountry: existing?.originCountry ?? null,
  ...
  return {
    ...
    originCountry: profileState.originCountry,
