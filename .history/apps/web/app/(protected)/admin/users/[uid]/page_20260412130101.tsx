    ...
    <div className="space-y-8 animate-in fade-in duration-700">
      ...
      <section className="rounded-[2rem] border border-white/20 dark:border-white/5 bg-white/60 dark:bg-zinc-950/40 backdrop-blur-2xl p-6 shadow-sm">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <DetailCard label="Device Label" value={targetUser.deviceLabel || "Unavailable"} />
          <DetailCard label="Device Label Source" value={targetUser.deviceLabelSource || "Unavailable"} />
          <DetailCard
            label="Device Label Confidence"
