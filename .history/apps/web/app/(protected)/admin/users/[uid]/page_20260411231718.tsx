...
export default async function AdminUserDetailPage({
  ...
  const errorMessages: Record<string, string> = {
    confirmation_required: "Confirmation is required before deleting a user account.",
    confirmation_mismatch: "Confirmation did not match the expected user identity.",
