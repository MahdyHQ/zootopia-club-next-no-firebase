...
export default async function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-x-hidden overflow-y-auto">
      ...
      <div className="z-10 w-full max-w-lg px-4 py-6 sm:px-6 sm:py-8">
        ...
        <div className="mt-8 text-center sm:mt-12">
          ...
          <p
            dir="rtl"
            className="public-login-signature mt-2 font-[family-name:var(--font-amiri)] text-[0.78rem] leading-6 text-foreground-muted/70 drop-shadow-sm"
          >
