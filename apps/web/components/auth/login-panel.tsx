...
export function LoginPanel({
  ...
  return (
    <div className="relative mx-auto w-full max-w-[440px] overflow-hidden rounded-[2rem] border border-white/15 bg-white/88 shadow-2xl shadow-black/20 backdrop-blur-2xl dark:bg-zinc-950/72 dark:shadow-black/50 sm:rounded-[2.25rem] p-8 sm:p-10 animate-in fade-in zoom-in-95 duration-700">
