  ...
  const homeVisionCards = [
    {
      ...
      body: "تم تطوير وبرمجة هذه المنصة خلال شهر كامل من التعب والمجهود والتكلفة، ولولا فضل الله ثم مساعدة أدوات الذكاء الاصطناعي لكان هذا العمل قد امتد إلى تسعة أشهر أو أكثر.",
      emoji: "🛠️",
      icon: Rocket,
      iconTone:
