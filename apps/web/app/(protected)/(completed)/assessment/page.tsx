...
export default async function AssessmentPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <section className="relative overflow-hidden rounded-[2.5rem] border border-white/15 bg-[linear-gradient(145deg,rgba(255,255,255,0.72),rgba(241,249,247,0.56))] p-6 shadow-sm backdrop-blur-xl dark:border-white/6 dark:bg-[linear-gradient(145deg,rgba(4,12,21,0.66),rgba(3,10,18,0.5))] sm:p-8 lg:p-10">
