...
function getContactMailConfiguration(): ContactMailConfiguration | null {
  ...
  // works in local development and Firebase App Hosting without leaking credentials.
...
function getContactMailer() {
  ...
  // development and Firebase App Hosting. Keep every credential and destination
